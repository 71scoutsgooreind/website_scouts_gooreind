  ...
  return (
    <>
      <div className="py-12">
        ...
        {/* Eerste PDF - september-november */}
        <section id="jefke1" className="my-12 bg-green-50 p-8 rounded-xl shadow-lg">
              ...
              <object data={jefkePdf} type="application/pdf" width="100%" height="100%">
                <div className="p-4 bg-red-100 border-l-4 border-red-500 text-red-700">
                  <p>
                    ...
                    <a href={jefkePdf} className="font-bold hover:underline">
                      Download het Jefke hier.
                    </a>
                  </p>
                </div>
              </object>
        ...
        {/* Tweede PDF - november-februari */}
        <section id="jefke2" className="my-12 bg-green-50 p-8 rounded-xl shadow-lg">
          <h3 className="text-green-900 text-3xl font-bold text-center mb-8">
          ...
          <div className="t-12">
            ...
            <div className="md:hidden text-center">
              <a
                href={jefkePdf2}
                download="jefke-nov-feb.pdf"
                className="inline-block bg-green-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-700 transition-colors s
